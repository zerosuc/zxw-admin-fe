...
export default ({ mode }: ConfigEnv): UserConfigExport => {
  // 更新路径，将环境变量文件放入 config/env 文件夹中
  const envDir = resolve(__dirname, "vite_env")
  const viteEnv = loadEnv(mode, envDir) as ImportMetaEnv

  // const viteEnv = loadEnv(mode, `./vite_env`) as ImportMetaEnv
